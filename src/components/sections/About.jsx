					...
					<div className="p-6 rounded-xl border-white/10 border hover:-translate-y-1 transition-all">
						...
						<div className="space-y-4 text-gray-300">
							<div className="space-y-2">
								...
								<p>
									Built new features and maintained a clean Vue.js codebase with
									Vuex and Vue Router in collaboration with cross-functional
									teams.
								</p>
							</div>
							...
							<div>
								...
								<p>
									...
									gaining proficiency in PowerApps, Flow, SharePoint, and Forms.
								</p>
							</div>
						</div>
					</div>
